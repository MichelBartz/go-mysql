...
You can see [go-mysql-elasticsearch](https://github.com/MichelBartz/go-mysql-elasticsearch) for how to sync MySQL data into Elasticsearch. 
...
```go
import (
    "github.com/MichelBartz/go-mysql/server"
    "net"
)
